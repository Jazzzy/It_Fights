...
enum DataMode { Aseprite_Array_Json_Data_WPivot };
...
class AnimatedSprite : public Drawable {
 public:
  AnimatedSprite(std::string dataFilename, std::string spriteSheetFilename,
                 DataMode dataMode);
  ~AnimatedSprite();
  ...
  void startAnimation(std::string name, bool loop,
