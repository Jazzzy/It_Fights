...
void GroundNoiseShader::drawWithShader(sf::RenderTarget* renderTarget,
                                       sf::Drawable* drawable) {
  //    this->sf_shader.setUniform("u_resolution", this->resolution);
  //    this->sf_shader.setUniform("u_time", (this->time +=
...
void GroundNoiseShader::drawWithShader(sf::RenderTarget* renderTarget,
                                       ...
                                       sf::Texture source) {
  this->sf_shader.setUniform("u_resolution", this->resolution);
  this->sf_shader.setUniform("u_time",
                             (this->time += Clock::Instance().getDeltaTime()));
