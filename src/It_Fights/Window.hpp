...
class Window : BusNode {
 public:
  Window(MessageBus *messageBus, Console *console, Collisions *collisionSystem,
         std::string windowName, int resolution_x, int resolution_y);
  ~Window();
  void update();
  ...
  void setCurrentInternalResolution(
