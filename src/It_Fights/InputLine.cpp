...
sf::String InputLine::getString() { return (">  " + this->stringContent); }

sf::String InputLine::getRealString() { return (this->stringContent); }
...
void InputLine::erase() { this->stringContent.clear(); }
