...
Level_00_GO_Characters::Level_00_GO_Characters(Scene* scene,
  ...
  switch (this->characterOptions) {
    case HUMAN_VS_AGENT:
      ...
      this->character_1 = new Level_00_GO_MainCharacter(
          scene, sf::Vector2f(120, 150), PLAYER_1);
      this->character_2 = new Level_00_GO_EnemyCharacter(
          scene, sf::Vector2f(280, 150), observer_2, PLAYER_2,
          REINFORCEMENT_1_BASED);
      break;
    case AGENT_VS_AGENT:
      this->observer_1 = new AIObserver(this, Position::PLAYER_1);
      this->observer_2 =
          new AIObserver(this, Position::PLAYER_2);  //  RULE_BASED
      this->character_1 = new Level_00_GO_EnemyCharacter(
          scene, sf::Vector2f(120, 150), observer_1, PLAYER_1, RULE_BASED);
      this->character_2 = new Level_00_GO_EnemyCharacter(
          scene, sf::Vector2f(280, 150), observer_2, PLAYER_2,
          REINFORCEMENT_1_BASED);
      break;
    case HUMAN_VS_HUMAN:
      this->character_1 = new Level_00_GO_MainCharacter(
          scene, sf::Vector2f(120, 150), PLAYER_1);
      this->character_2 = new Level_00_GO_MainCharacter(
          scene, sf::Vector2f(280, 150), PLAYER_2);
      break;
  }
}
...
Level_00_GO_Characters::~Level_00_GO_Characters() {
  ...
  if (this->observer_1 != nullptr) delete this->observer_1;

  if (this->observer_2 != nullptr) delete this->observer_2;
}
...
void Level_00_GO_Characters::onStart() {
  ...
  if (this->observer_1 != nullptr) this->observer_1->update();

  if (this->observer_2 != nullptr) this->observer_2->update();
}
 ...
 */
struct {
  bool operator()(Level_00_GO_BasicCharacter* a,
                  Level_00_GO_BasicCharacter* b) {
...
void Level_00_GO_Characters::draw(sf::RenderTarget* renderTarget) {
  std::array<Level_00_GO_BasicCharacter*, 2> characterVector = {
      this->character_1, this->character_2};
