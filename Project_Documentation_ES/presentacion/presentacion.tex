...
% \section{Deseño}
% \subsection{Clases do bus de mensaxes}
...
\begin{figure}[h]
	\centerline{\includegraphics[width=11cm]{../otros/otrasCapturas/grafico_victorias.png}}
...
\begin{figure}[h]
	\centerline{\includegraphics[width=11cm]{../otros/otrasCapturas/grafico_estados.png}}
	\label{graf:estados}
\end{figure}
